...
Patch0: subscription-manager.patch
# https://issues.redhat.com/browse/RHEL-80151
Patch1: subscription-manager-translations.patch
# https://issues.redhat.com/browse/RHEL-30353
Patch2: toggle-activities-overview-shortcut.patch
# https://issues.redhat.com/browse/RHEL-81055
Patch3: wwan-apn-attach.patch
# https://issues.redhat.com/browse/RHEL-22606
Patch4: multitasking-add-window-control-settings.patch
# https://issues.redhat.com/browse/RHEL-83848
Patch5: a11y-text-size-setting.patch
# https://issues.redhat.com/browse/RHEL-131149
Patch6: a11y-user-password-fixes.patch
# https://issues.redhat.com/browse/RHEL-124241
Patch7: mutter-shell-49-compat.patch
# https://issues.redhat.com/browse/RHEL-81052
...
* Wed Feb 18 2026 Florian Müllner <fmuellner@redhat.com> - 47.7-7
- Add HDR switch in display panel

* Wed Feb 04 2026 Felipe Borges <felipeborges@gnome.org> - 47.7-6
- Allow setting primary sim slot in Mobile Networks (WWAN) settings

* Fri Dec 19 2025 Felipe Borges <felipeborges@gnome.org> - 47.7-5
- Add compatibility patches with mutter/shell 49

* Wed Dec 10 2025 Felipe Borges <felipeborges@gnome.org> - 47.7-4
- Announce password change states to screen reader

* Fri Nov 14 2025 Felipe Borges <felipeborges@gnome.org> - 47.7-3
- Add rpminspect ignore list

* Wed Nov 12 2025 Felipe Borges <felipeborges@gnome.org> - 47.7-2
- a11y: Add "Text Size" setting

* Fri Jun 27 2025 Felipe Borges <felipeborges@gnome.org> - 47.7-1
- Update to 47.7

* Fri Jun 06 2025 Felipe Borges <felipeborges@gnome.org> - 47.6-3
- Add "Minimize and Maximize" window control settings

* Tue May 27 2025 Felipe Borges <felipeborges@gnome.org> - 47.6-2
- Add Access Point "Attach" setting to wwan connections

* Tue May 27 2025 Felipe Borges <felipeborges@gnome.org> - 47.6-1
- Update to 47.6

* Fri May 09 2025 Felipe Borges <felipeborges@gnome.org> - 47.5-2
- Add option to enable/disable Activities Overview Shortcut

* Thu Apr 17 2025 Felipe Borges <felipeborges@gnome.org> - 47.5-1
- Update to 47.5

* Tue Feb 25 2025 Felipe Borges <felipeborges@gnome.org> - 47.3-5
- Add subscription-manager translations for supported languages

* Fri Feb 07 2025 Felipe Borges <feborges@redhat.com> - 47.3-4
- Add subscription manager support

* Mon Feb 03 2025 Felipe Borges <feborges@redhat.com> - 47.3-3
- Revert "Honor sleep inactive-act-type-server g-s-d setting"

* Mon Jan 20 2025 Felipe Borges <feborges@redhat.com> - 47.3-2
- Replace power-profiles-daemon with tuned-ppd

* Mon Jan 13 2025 Felipe Borges <feborges@redhat.com> - 47.3-1
- Update to 47.3

* Tue Nov 26 2024 Felipe Borges <feborges@redhat.com> - 47.2-1
- Update to 47.2

* Tue Oct 29 2024 Troy Dawson <tdawson@redhat.com> - 47~alpha-5
- Bump release for October 2024 mass rebuild:

* Tue Oct 29 2024 Felipe Borges <feborges@redhat.com> - 47~alpha-4
- Honor sleep inactive-act-type-server g-s-d setting

* Wed Jul 31 2024 Felipe Borges <feborges@redhat.com> - 47~alpha-3
- Drop setxkbmap dependency

* Wed Jul 17 2024 Felipe Borges <feborges@redhat.com> - 47~alpha-2
- Fix typo in gsettings-desktop-schemas version

* Tue Jul 16 2024 Felipe Borges <feborges@redhat.com> - 47~alpha-1
- Update to 47.alpha

* Wed Jul 10 2024 Felipe Borges <felipeborges@gnome.org> - 46.3-1
- Update to 46.3

* Mon Jun 24 2024 Troy Dawson <tdawson@redhat.com> - 46.2-3
- Bump release for June 2024 mass rebuild

* Thu May 30 2024 Tomas Pelka <tpelka@redhat.com> - 46.2-2
- Add gating.yaml via API

* Tue May 28 2024 Felipe Borges <feborges@redhat.com> - 46.2-1
- Update to 46.2

* Mon May 13 2024 Tomas Popela <tpopela@redhat.com> - 46.0.1-2
- Rebuild for libgoa-backend soname bump

* Thu Mar 28 2024 Felipe Borges <felipeborges@gnome.org> - 46.0.1-1
- Update to 46.0.1
